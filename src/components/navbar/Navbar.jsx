            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  <Link to={'/allcars'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    All Cars
                  </Link>
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#" className="-m-2 flex items-center p-2">
                    <img
                      src="https://th.bing.com/th/id/OIP.s1roP5Kf6FZQnyK0eMk9-gHaFj?rs=1&pid=ImgDetMain"
                      alt=""
                      className="block h-auto w-5 flex-shrink-0"
                    />
                    <span className="ml-3 block text-base font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '', }}>Link</span>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl sm:text-2lg font-bold text-gray-600 px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>WTG Car Rentals</h1>
                    <img src="C:\Users\Julios\Desktop\wtg-car-rentals\src\assets\aa.png" alt="" />
                  </div>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <Link to={'/allcars'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    All Cars
                  </Link>
                ...
                <div className="hidden lg:ml-8 lg:flex">
                    <span className="ml-3 block text-sm font-medium" style={{ color: mode === 'dark' ? 'white' : '', }}>{currentUser?.email}</span>
                </div>
                <div className="hidden lg:ml-8 lg:flex">
                ...
                <div className="flex lg:ml-6">
                  <button className='' onClick={toggleMode}>
                    ...
                    {mode === 'light' ?
                      (<FaSun className='text-gray-400' size={30} />
                      ) : 'dark' ?
                        (<BsFillMoonStarsFill className='text-slate-500' size={30} />
                        ) : ''}
                  </button>
                </div>
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/cart'} className="group -m-2 flex items-center p-2 text-slate-500" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
